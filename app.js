...
app.post('/mode', function(req, res) {
  ...
  console.log("esto es respuesto a post mode");
  console.log(res);
...
app.get('/info', function(req, res) {
  ...
  var patientdata;
  console.log("esto es modo actual "+CURRENTMODE);
...
app.post('/login', function(req, res) {
  ...
  console.log("Esto es API_URL "+API_URL);

  var patientLogin = backendApi.patientLogin(API_URL, req.query.username, req.query.password);

  console.log('esto es patientlogin '+patientLogin)

  patientLogin.then(function(resultid) {


    console.log('sebastian == '+resultid)
    res.send(resultid);
